...
namespace TelegramBotWeather
{
    ...
    internal class Program
    {
        ...
        private static readonly string GeocoderApiKey = "GeocoderApiKey";
        private static readonly string WeatherApiKey = "WeatherApiKey";

        private static readonly string BotApiKey = "BotApiKey";
